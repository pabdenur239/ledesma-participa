...
def _publicar_en_instagram(db, prog_id, fila, cliente_fb, cliente_ig, noticia, photo_id):
    ...
    try:
        ...
        # explícitamente: si Meta no entrega una URL de Facebook apta para
        # Instagram (obtener_url_publica_foto), se detiene acá y queda
        # reportado el bloqueo — nunca se intenta un hosting alternativo.
